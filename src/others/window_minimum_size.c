...
Melhorias a serem feitas depois:
	a quantidade de linhas e colunas devem
	ser calculadas usando o struct t_dot
	a struct t_map deve ser preenchida no
	arquivo fdf.c e passada para os outros arquivos

	btw: a string contendo o o map.fdf deve ser
	lida apenas para criar a struct t_dot
